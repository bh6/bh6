...
This sample application demonstrates how to use Java JPA to connect to a SQL Database.

Files

The Java DB Web starter application contains the following contents:
