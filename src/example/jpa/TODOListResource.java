...
public class TODOListResource {
	...
	private synchronized List<TODO> allTodos() {
		String selectQuery = "SELECT t FROM TODO t";
		List<TODO> list = em.createQuery(selectQuery, TODO.class).getResultList();
		if (list.size() == 0) {
			create("sample entry #1");
			create("sample entry #2");
			create("sample entry #3");
			list = em.createQuery(selectQuery, TODO.class).getResultList();
		}
		return list;
	}
